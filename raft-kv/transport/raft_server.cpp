...
namespace kv
{
    ...
    {
    public:
        // On the specified IP and port AsioServer instance starts to listen for incoming requests
        ...
        // This function creates a new ServerSession instance with io_service_ from Transport
        // and starts to asynchronously accept incoming requests with a handler function that
        // restart the async_accept() process and then start_read_meta()
        // Each accepted request will have a ServerSession instance with a new socket
        void start() final
        {
    ...
    // This is a simple encapsulation for creating a new AsioServer instance, mainly for creating an acceptor_ instance
    // for listening incoming requests
