...
namespace kv
{
    ...
    private:
        ...
        // This is the last log index that is in memory
        // Initially set by the read-in content from WAL
        ...
        // This is the initially set by the read-in content from snopshotter's load_snap
