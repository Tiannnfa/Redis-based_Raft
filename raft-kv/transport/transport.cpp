...
namespace kv
{
    ...
    public:
        ...
        // This function creates IoServer instance and then start the acceptor_
        // Use another thread to call io_service.run() for processing events
        ...
        // Add pper info to Transport instance 
        // Transport uses Peer(PeerImpl) class member to communicate with peer as a client
